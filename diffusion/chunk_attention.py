...
def _query_chunk_attention(query, key, value, key_chunk_size=4096, precision=jax.lax.Precision.HIGHEST):
...
def attention(query, key, value, query_chunk_size=1024, precision=jax.lax.Precision.HIGHEST):
